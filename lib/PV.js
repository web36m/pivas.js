/*!
 * PiVas JavaScript framework v1.0.1
 * http://pivas.net/
 *
 * Copyright 2012, 2013 Shilov Vasily
 * Released under the MIT license
 * http://pivas.net/license.html
 *
 * Date: Sun Mar 24 2013 17:44:09 GMT+0400 (MSK)
 */
...
(function(){
	...
	PV.init = function(config){
		...
		console.log([PV.config, config, defaults]);
